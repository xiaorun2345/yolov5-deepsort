...
sleep 3
log="/home/user/CameraTestDemo/ip_test_log.log"
configFile="/home/user/CameraTestDemo/NL_config.ini">>$log
path="/home/user/CameraTestDemo/"
clear
...
local_ip=`ReadINIfile "local_ip" "NL_config" "$configFile"`
rsu_ip=`ReadINIfile "rsu_ip" "NL_config" "$configFile"`
cam_ip=`ReadINIfile "cam_ip" "NL_config" "$configFile"`
